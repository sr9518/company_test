    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<c:if test="${registerFlag == 'modify'}">
        		<tr>
        			<td class="tbtd_caption"><label for="id"><spring:message code="title.sample.usertype" /></label></td>
    		...
    		<tr>
    			...
    			<td class="tbtd_content" colspan="3">
    				...
    				<form:checkbox path="emailchk1" cssClass="chk" value="0"/> 이메일 수신동의
    				<form:checkbox path="emailchk2" cssClass="chk" value="0"/> 서신할당 알림메일 수신허용(해외거주 등 문자수신 불가한 경우)
    			</td>
    		</tr>
    		<tr>
    			...
    			<td class="tbtd_content" colspan="3">
    				...
    				<form:radiobutton path="birthchk" cssClass="chk" value="0"/> 음력
    				<form:radiobutton path="birthchk" cssClass="chk" value="1"/> 양력
    			</td>
    		</tr>
    		<tr>
    			...
    			<td class="tbtd_content">
    				...
    				<form:checkbox path="phonechk" cssClass="chk"/> SMS 수신동의
    			</td>
    			<td class="tbtd_caption"><label for="job"><spring:message code="title.sample.job" /></label></td>
    			<td class="tbtd_content">
    				<form:input path="job" maxlength="16" cssClass="txt" />
    				<form:checkbox path="jobchk" cssClass="chk"/> 직업 정보 동의
    			</td>
    		</tr>
    		<tr>
    			<td class="tbtd_caption"><label for="juso1"><spring:message code="title.sample.juso1" /></label></td>
    			<td class="tbtd_content" colspan="3">
    				<form:input path="juso1" maxlength="16" cssClass="txt" />
    				<form:input path="juso2" maxlength="16" cssClass="txt" />
    				<form:checkbox path="jusochk" cssClass="chk"/> 자택주소 정보 동의
    			</td>
    		</tr>
    		<tr>
