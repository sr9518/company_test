...
public class EgovSampleController {
	...
	public Map<String,Object> updateSampleView1(@RequestParam("selectedId") String itemId, @ModelAttribute("searchVO") SampleDefaultVO searchVO, Model model) throws Exception {
	...
	@ResponseBody
	public Map<String,Object> ListAjax(String itemId, SampleDefaultVO searchVO, SampleVO sampleVO)throws Exception {
