...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<!-- List -->
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="번호, 유형구문, 봉사단계, 이름, 생년월일, 아이디, 이메일, 번역구분, 담당직원, 가입일">
        			<caption style="visibility:hidden">번호, 유형구문, 봉사단계, 이름, 생년월일, 아이디, 이메일, 번역구분, 담당직원, 가입일</caption>
        			<colgroup>
        				<col width="40"/>
        				<col width="100"/>
        				<col width="150"/>
