...
<form method="post" action="info_ok" enctype="multipart/form-data">
                        ...
                        <tr>
                          ...
                          <td width="456"><table width="423" border="0" cellspacing="2" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td height="26"><input name="jumin1" type="text" size="15">
      -
          ...
          <td height="13" align="center"><table width="600" border="0" cellspacing="0" cellpadding="0">
              <tr> 
               ...
               년               
                              ...
                              일 ( 
                              <input type="radio" name="yang" value="0">
                              양력 
                              <input type="radio" name="yang" value="1">
                              음력 )</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> <input type="radio" name="sung" value="0">
                              남자
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> <input type="radio" name="wedding" value="0">
                              미혼 
                              <input type="radio" name="wedding" value="1">
                             기혼</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="yuncha" type="text" size="10"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="juso1" type="text" size="10"> 
                              <input name="juso2" type="text" size="40"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="tec" type="text" size="20"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="soju" type="text" size="20"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
